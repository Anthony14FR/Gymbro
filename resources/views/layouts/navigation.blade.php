<div class="bg-[#131417] shadow-md z-40 relative border-b-4 border-gray-500/20">
    <nav class="navbar flex justify-between container mx-auto">
        <div class="">
            <div href="{{ route('subscriptions.index') }}" class="text-xl flex items-center gap-5 p-3">
                ...
                @if (Auth::check())
                    @if (Auth::check() && Auth::user()->hasRole('admin'))
                        ...
                        <a href="{{ route('users.index') }}" class="text-xs btn">Dashboard</a>
                    ...
                    @elseif (Auth::check() && Auth::user()->hasRole('user'))
                        <a href="{{ route('subscriptions.index') }}" class="text-xl flex items-center gap-5">
                            <div
                                ...
                                <span class="text-xs cursor-default">Pas encore abonné ? Clique <a
        ...
        <div class="">
            @auth
                <div class="dropdown dropdown-end lg:hidden block">
                    <div tabindex="0" role="button" class="btn m-1 text-white">Menu <i class="fa-solid fa-bars"></i>
                    </div>
                    <ul tabindex="0"
                ...
                <div class="space-x-3 p-2 lg:flex hidden">
